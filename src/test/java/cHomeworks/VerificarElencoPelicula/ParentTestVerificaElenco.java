...
public class ParentTestVerificaElenco {
	...
	public static void verificarElenco() {

	}


	// otra actividad add movie and validate on watchlist
	public static void selectMovieAdd() {

	}

	public static void verifyWatchList() {
	}
