...
public class PaginaBaseWait {
    ...
    static void navegarPagina(String url) {
    ...
    static void seleccionarTelefonosYSmartphones() {
    ...
    static void verificarModalSeleccionaTuEstado() {
    ...
    static void seleccionarEstado(String estado) {
    ...
    static CelularWait capturarInformacionTelefono(int i) {
        ...
        return new CelularWait(nombreEquipoCel, capac, precio);
    }
    ...
    public static void verificarInformacionCelular(CelularWait cel) throws Exception {
